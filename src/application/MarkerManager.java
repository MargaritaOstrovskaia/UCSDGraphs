...
public class MarkerManager {
    ...
    /** Used to set reference to visualization button. Manager will be responsible for disabling button
     * @param vButton */
    ...
    // protect against this being called without visualization built
    ...
    /** Might need to create all new markers and add them?? */
